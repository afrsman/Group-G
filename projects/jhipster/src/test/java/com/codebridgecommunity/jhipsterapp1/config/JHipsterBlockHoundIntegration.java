...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.codebridgecommunity.jhipsterapp1.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "com.codebridgecommunity.jhipsterapp1.security.DomainUserDetailsService",
